...
angular.module('appDynApp')
    ...
    .controller('listAttributesCtrl', ['$scope', '$http', '$location', function($scope, $http, $location) {
        ...
        $http.get('./getFormDataList/' + $scope.formid).success(function (data, status, headers, config) {
            $scope.messages = data;
